...
#ifndef GET_SINK_SCREEN_INFOS_CALL_BACK_STUB_H
#define GET_SINK_SCREEN_INFOS_CALL_BACK_STUB_H
...
private:
    DISALLOW_COPY_AND_MOVE(GetSinkScreenInfosCallbackStub);
};
} // namespace DistributedInput
} // namespace DistributedHardware
} // namespace OHOS

#endif // GET_SINK_SCREEN_INFOS_CALL_BACK_STUB_H
